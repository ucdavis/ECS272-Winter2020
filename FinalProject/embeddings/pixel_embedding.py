...
resizes each image in the dataFrame to be 100x100 pixels, converts to grayscale so the
shape is 100x100x1, flattens to an array of length 10000, saves this
