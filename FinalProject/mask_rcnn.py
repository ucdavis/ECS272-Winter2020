...
for i in range(0, boxes.shape[2]):
	...
	if confidence > args["confidence"]:
		...
		'''POI: Here is where we chose color. After classification, we should have a color dictionary to
		color by category, or we should make it yellow if we are in price view'''
